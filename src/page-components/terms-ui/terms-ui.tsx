...
export type TermsProps = CommonTypes;

const TermsUI: FC<TermsProps> = ({ className }) => {
    ...
    <section className={cnRoot}>
      <Container className={cnContainer}>
        <div className={cnPart}>
          <h2 className={cnTitle}>TERMS OF SERVICE</h2>
          <h3 className={cnPartTitle}>Last updated July 12, 2023</h3>
        </div>

        <div className={cnPart}>
          <h3 className={cnPartTitle}>AGREEMENT TO OUR LEGAL TERMS</h3>
          <p className={cnText}>
            We are Momentum Max LLC ("Company," "we," "us," "our").
          </p>
          <p className={cnText}>
            We operate the website https://momentummax.co (the "Site"), as well
            as any other related products and services that refer or link to
            these legal terms (the "Legal Terms") (collectively, the
            "Services").
          </p>
          <p className={cnText}>
            You can contact us by email at hello@momentummax.co or by mail to
            7901 4th St N, St. Petersburg, FL 33702, USA, St. Petersburg, FL
            33702, United States.
          </p>
          <p className={cnText}>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and Momentum Max LLC, concerning your access to and use of the
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>1. OUR SERVICES</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>2. INTELLECTUAL PROPERTY RIGHTS</h3>
          <h3 className={cnPartTitle}>Our intellectual property</h3>
          <p className={cnText}>
          ...
          <h3 className={cnPartTitle}>Your use of our Services</h3>
          <p className={cnText}>
          ...
          <p className={cnText}>
            ...
            please address your request to: hello@momentummax.co. If we ever
          ...
          <h3 className={cnPartTitle}>Your submissions</h3>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>3. USER REPRESENTATIONS</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>4. PROHIBITED ACTIVITIES</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>5. USER GENERATED CONTRIBUTIONS</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>6. CONTRIBUTION LICENSE</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>7. THIRD-PARTY WEBSITES AND CONTENT</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>8. SERVICES MANAGEMENT</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>9. PRIVACY POLICY</h3>
          <p className={cnText}>
            We care about data privacy and security. Please review our Privacy
            Policy: https://momentummax.com/privacy. By using the Services, you
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>10. TERM AND TERMINATION</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>11. MODIFICATIONS AND INTERRUPTIONS</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>12. GOVERNING LAW</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          ...
          <p className={cnText}></p>
        </div>

        <div className={cnPart}>
          <h3 className={cnPartTitle}>13. DISPUTE RESOLUTION</h3>
          <h3 className={cnPartTitle}>Informal Negotiations</h3>
          <p className={cnText}>
          ...
          <h3 className={cnPartTitle}>Binding Arbitration</h3>
          <p className={cnText}>
            ...
            Orange, Florida. Except as otherwise provided herein, the Parties
          ...
          <p className={cnText}>
            ...
            state and federal courts located in Orange, Florida, and the Parties
          ...
          <h3 className={cnPartTitle}>Restrictions</h3>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>14. CORRECTIONS</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>15. DISCLAIMER</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>16. LIMITATIONS OF LIABILITY</h3>
          <p className={cnText}>
            ...
            ARISING OR $10,000.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>17. INDEMNIFICATION</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>18. USER DATA</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>20. CALIFORNIA USERS AND RESIDENTS</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>21. MISCELLANEOUS</h3>
          <p className={cnText}>
        ...
        <div className={cnPart}>
          <h3 className={cnPartTitle}>22. CONTACT US</h3>
          <p className={cnText}>
