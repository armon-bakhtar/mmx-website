...
const SvgChile = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#chile_svg__a)">
      <g clipPath="url(#chile_svg__b)">
        ...
        <path
          fill="#fff"
          fillRule="evenodd"
          d="m4.491 5.576-1.54.824.294-1.745L2 3.418l1.721-.254.77-1.59.77 1.59 1.721.256-1.246 1.235L6.03 6.4"
          clipRule="evenodd"
        />
        <path
          fill="#F93939"
